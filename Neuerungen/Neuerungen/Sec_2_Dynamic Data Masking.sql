...
INSERT  [dbo].[Mitarbeiter]
        ( [Name], [Gehalt], [Telefon], [EMail], Gebdatum )
VALUES  ( 'Hugo Drink', 999.9, '1234567', 'Hugo@sql.eu',getdate()),
        ( 'James Bond', 12000.0, '234567', 'jbond@dotnetconsulting.eu',getdate()),
        ( 'Harry Bo', 9.99, '3456789', 'harry@brexit.eu', getdate());
